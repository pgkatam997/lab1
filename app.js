...
var ProGrad_1, ProGrad_2;
var i;
var get;

// 1.1 Create a variable `ProGrad-1` with the driver's name.
var ProGrad_1="purnima"
// 1.2 Print `"The driver's name is XXXX"`.
console.log(ProGrad_1);
// 1.3 Create a variable `ProGrad-2` with the navigator's name.
var ProGrad_2="Saikumar"
...
if (length_1 > length_2) {
    ...
    console.log(" It seems that the navigator has the longest name, it has"+ " "+ length_2 + "characters");
}
else{
...
var proGrad_2 = ProGrad_2.toLowerCase(); 
 for (    var length = proGrad_2.length, 
    position = 0;   
     length >= 0;   
      length--, 
      position++ )
...
console.log("number of Lower Case Letters are" + capsCount);
...
console.log(reverseString("purnima"));
...
{
    console.log("the navigation is" + " " + ProGrad_2 + " " + ProGrad_1 );
}
